...
class FeatureGenerator():
    def generate_training(self, world = "herox", maxno=None):
        ...
        for feature in found_features:
            ...
            if y == 1:
                ...
                countmax+=1
                if maxno is not None and countmax >= maxno:
                    break
        ...
        for feature in found_features:
            ...
            if y == 1:
                ...
                if maxno is not None and done >= maxno:
                    break
        ...
        #pickle.dump(Xs, open("dump.x","wb+"))
        #pickle.dump(ys, open("dump.y","wb+"))
        #pickle.dump(self.bow.words,open("dump.bow","wb+"))
        #pickle.dump(self.mc.headers.words,open("dump.mc","wb+"))
        return Xs, ys
    ...
    def generate_test(self, tables, question):
        ...
        for tuple in tuples:
            ...
            q_bow = flatten_without_labels({"bow": words})
