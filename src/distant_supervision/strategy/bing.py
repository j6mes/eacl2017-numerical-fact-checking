...
def bing_query(id,query,retry=True):
    ...
    accountKey = "7386effe49104112883f103c3671b819" #"e3e25c820a9c43a6adccc0a56c553150" # 'Za3DcaKVzmNfucTGZWq+sfM8G93sWPjS3sgeKUg7z7Y'#"ZAk6G5VxGSD+K/mx3QH+PX24x85Cx9lEVnQzXA5H+P0" #
